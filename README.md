...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Hello!+I'm+Jo'rabek+👋;Backend+Developer+|+Node.js+%26+React;Always+learning+new+things+🚀;Open+to+new+opportunities+💼)](https://git.io/typing-svg)
...
- 💼 Junior Backend Developer based in **Uzbekistan**
- 🔭 Currently building real-world projects to grow my skills
- 🌱 Always learning — focused on **backend architecture** and **clean code**
- 💡 I enjoy turning ideas into working web applications
- 📫 Open to **junior / trainee positions**
...
|--------|-------------|-------|
| 🤖 Telegram Bot | Notification bot with user registration & admin panel | Node.js, Telegraf, TypeORM |
| 🌐 Web App | Full-stack web application with REST API | Node.js, Express, React, PostgreSQL |
| 📌 Pinterest Clone | Full-stack web application with REST API | Node.js, Express, React, PostgreSQL |
...
![Visitor Count](https://komarev.com/ghpvc/?username=egamberd1yev&color=blue&style=for-the-badge)
